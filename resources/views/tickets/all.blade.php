<x-layout>
    <x-slot:heading>
        Base de Datos de los Tickets de Servicios de de Todas las Coordinaciones
    </x-slot:heading>    
    
    <div class="flex flex-col md:flex-row md:items-center md:justify-between mb-6 gap-4">
        
        <div>
            <h2 class="font-bold text-lg text-gray-800">Base de Datos de los Tickets de Servicios de de Todas las Coordinaciones.</h2>
