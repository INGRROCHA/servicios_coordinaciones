            ...
            <form method="POST" action="/tickets/{{ $ticket->id_ticket }}" id="edicion" name="edicion">    
                ...
                <div class="tabla">
                    ...
                    <div class="mt-8 flex justify-end gap-4 border-t pt-6">
                        <a href="/" class="bg-gray-500 text-white text-lg font-semibold px-8 py-3 rounded-lg shadow hover:bg-gray-700 transition duration-200" style="text-decoration: none;">
                            Cancelar
                        </a> 
