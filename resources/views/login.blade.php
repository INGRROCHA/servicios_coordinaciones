    ...
    <div class="w-full max-w-md bg-white rounded-lg shadow-md p-8 m-6">
                ...
                <form id="loginForm" novalidate>
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" id="num_eco" name="num_eco" class="mt-1 block w-full border border-gray-300 rounded-md p-2 focus:ring-blue-500 focus:border-blue-500" placeholder="Ingresa tu matrícula">
